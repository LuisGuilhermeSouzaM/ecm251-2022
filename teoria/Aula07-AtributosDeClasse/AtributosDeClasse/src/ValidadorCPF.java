...
public class ValidadorCPF {
    private static List<Integer> cpfInvalido = new ArrayList<Integer>(){{add(1); add(1); add(33333333333); add("44444444444"); add("55555555555"); add("66666666666"); add("77777777777"); add("88888888888"); add("99999999999"); add("00000000000");}};
